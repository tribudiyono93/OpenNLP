package learn.opennlp.data.train;
...
public class NERTrainingExample {
	public static void main(String[] args) {
        ...
        try {
            in = new MarkableFileInputStreamFactory(new File("src/main/resources/AnnotatedSentences.txt"));
        ...
        String[] testSentence ={"Alisa","Fernandes","is","a","tourist","from","Veilchenstra"};
