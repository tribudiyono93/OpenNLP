...
public class PersonClassifierTrainer {
	...
	static String onlpModelPath = "src/main/resources/en-person.bin";
	// training data set
	static String trainingDataFilePath = "src/main/resources/person-data-training.txt";
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			model = NameFinderME.train("en", "person", sampleStream, Collections.emptyMap());
		} finally {
			sampleStream.close();
		}
